...
//                 <div className={`absolute bottom-2 right-2 translate-y-2 opacity-0 transition-all duration-300 ${hovered ? 'opacity-100 translate-y-0' : ''}`}>
...
//                 />
//                 {/* Botón de Play flotante (estilo Spotify) */}
//                 <div className={`w-12 h-12 bg-[#1ED760] rounded-full flex justify-center items-center shadow-xl/30 absolute bottom-2 right-2 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-out hover:bg-[#1fdf64] hover:scale-105`}>
...
// function MainResultAlbum({ album }) {
//     // const year = album.release_date ? album.release_date.split("-")[0] : "";
//     const typeLabel = album.album_type === "single" ? "Sencillo" : album.album_type === "ep" ? "EP" : "Álbum";
...
//             {/* Botón play */}
//             <div className="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-200">
//                 <div className="w-12 h-12 bg-[#1ED760] rounded-full flex items-center justify-center shadow-xl hover:scale-105 hover:bg-[#1fdf64] transition-all">
//                     <FaPlay size={18} className="text-black ml-0.5" />
//                 </div>
//             </div>
